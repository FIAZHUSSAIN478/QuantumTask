...
function Section7() {
  ...
  return (
    <div className="w-full bg-white py-20 px-6 lg:px-20 md:px-10">
      <div className="max-w-7xl mx-auto grid lg:grid-cols-2 md:grid-cols-2 lg:gap-30 md:gap-2 gap-10 items-center">
        <div>
